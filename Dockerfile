 --- ETAPA 1: Compilación de la aplicación (Build) --- FROM 
node:20-alpine AS build WORKDIR /app
# Copiamos los archivos de empaquetado e instalamos dependencias
COPY package*.json ./ RUN npm install --legacy-peer-deps
...
# Nota: Verifica si Angular 18 compila en 'dist/lifegoals/browser' o 
# solo 'dist/lifegoals'
